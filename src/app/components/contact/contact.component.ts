    ...
    <section id="contact" class="py-32 px-6">
      <div class="max-w-2xl mx-auto">
        ...
        <div class="flex justify-center gap-6">
          <a
            href="https://wa.me/351937050505"
            target="_blank"
            rel="noopener noreferrer"
            class="w-12 h-12 rounded-full border-2 border-border hover:border-accent flex items-center justify-center transition-all duration-300 hover:scale-110 hover:bg-accent/10"
          >
          ...
          <a
            href="https://github.com/mayragss"
            target="_blank"
            rel="noopener noreferrer"
            class="w-12 h-12 rounded-full border-2 border-border hover:border-accent flex items-center justify-center transition-all duration-300 hover:scale-110 hover:bg-accent/10"
          >
